<%-- 
  ...
  Optional attributes:
    ...
    hideViewAllOption
      Boolean flag to indicate if we hide the view all option; Defaults to false.
  --%>
...
<%@ attribute name="hideViewAllOption" required="false" type="java.lang.Boolean" %>
...
<dsp:page>
  ...
  <div class="atg_store_pagination">
    <ul>
      ...
      <c:if test="${size > arraySplitSize && !hideViewAllOption}">
