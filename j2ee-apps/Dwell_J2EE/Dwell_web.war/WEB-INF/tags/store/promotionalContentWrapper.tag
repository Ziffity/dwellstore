      ...
      <c:choose>
        ...
        <c:when test="${not empty siteId}">
          ...
          <dsp:include page="/global/gadgets/crossSiteLinkGenerator.jsp">
            ...
            <dsp:param name="customUrl" value="/home"/>
          </dsp:include>
...
<!-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/WEB-INF/tags/store/promotionalContentWrapper.tag#1 $$Change: 946917 $ -->
