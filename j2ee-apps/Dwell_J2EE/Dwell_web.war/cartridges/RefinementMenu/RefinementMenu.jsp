          ...
          <ul class="atg_store_facetOptions" dojoattachpoint="containerNode">
            <c:choose>
              <c:when test="${contentItem.dimensionName eq 'product.category'}">
               ...
               <%-- refinement: ${refinement.navigationState}--%>
                  <c:set var="categoryId" value="${refinement.properties['category.repositoryId'] }"/>
                    <preview:repositoryItem itemId="${categoryId}" itemType="category"
                      ...
                      <li>
                       <dsp:a href="${refinement.contentPath}${refinement.navigationState}" title="${refinement.label}">
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/cartridges/RefinementMenu/RefinementMenu.jsp#2 $$Change: 953229 $--%>
