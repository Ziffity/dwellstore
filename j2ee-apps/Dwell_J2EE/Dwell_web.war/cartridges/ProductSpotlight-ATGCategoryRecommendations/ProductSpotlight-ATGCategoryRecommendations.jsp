<%--
  ...
  Recommendations will not be generated when the site is being crawled. The 
  reasons for this are because customers get charged per session and nonsensical 
  recommendations will be generated for a bot randomly crawling the site.
...
<dsp:page>  
  ...
  <dsp:droplet name="BrowserTyperDroplet">
    <dsp:oparam name="output">
      ...
      <%-- 
        When the site is being crawled, don't display any recommendations.
        Crawlers generate a lot of sessions which inflates the customers cost 
        for recommendations since they charge per session.
        
        Recommendations that get generated for something crawling the site 
        randomly, like a bot, are bad since what "the customer" looked at is 
        such a strong driver of what gets shown. Looking at things randomly 
        causes nonsensical recommendations.
      --%>
      <c:if test="${browserType ne 'robot'}">
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/cartridges/ProductSpotlight-ATGCategoryRecommendations/ProductSpotlight-ATGCategoryRecommendations.jsp#1 $$Change: 946917 $--%>