      ...
      <div id="atg_store_spotlightSeeAllLink">
       ...
       <%--
        ...
        <dsp:droplet name="ActionURLDroplet">
          <dsp:param name="action" value="${contentItem.seeAllLink}"/>
          
          <dsp:oparam name="output">
            <dsp:getvalueof var="actionURL" param="actionURL"/>
            <c:set var="seeAllActionUrl" value="${actionURL}"/>
            
            <a href="${seeAllActionUrl}">
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/cartridges/HorizontalRecordSpotlight/HorizontalRecordSpotlight.jsp#1 $$Change: 946917 $ --%>
