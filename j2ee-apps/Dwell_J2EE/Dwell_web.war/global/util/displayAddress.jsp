      ...
      <c:choose>
        ...
        <c:otherwise>
          ...
          <div class="vcard">
            ...
            <div class="adr">
              <dsp:getvalueof var="isPrivate" param="private"/>
              <c:choose>
                <c:when test="${isPrivate == 'true'}">
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/global/util/displayAddress.jsp#2 $$Change: 953229 $--%>
