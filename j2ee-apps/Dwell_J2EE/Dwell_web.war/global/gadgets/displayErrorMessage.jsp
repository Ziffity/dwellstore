...
<dsp:page>
  ...
  <c:if test="${not empty formExceptions}">
    <div class="atg_store_formValidationError">
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/global/gadgets/displayErrorMessage.jsp#2 $$Change: 1179550 $--%>
