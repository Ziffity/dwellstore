  ...
  Required Parameters:
    mode 
     The display mode for the site indicator, valid values are:
       ...
       banner - the site indicator is a banner style name across the image
...
<dsp:page>
  ...
  <c:if test="${(siteId != currentSiteId) || displayCurrentSite}">
    ...
    <c:choose>
      ...
      <c:when test="${mode == 'banner'}">
        <span class="siteIndicatorBannerContainer">            
          <span class="siteIndicatorBanner"><c:out value="${siteName}"/></span>
        </span>
      </c:when>
      <c:otherwise>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/global/gadgets/siteIndicator.jsp#1 $$Change: 946917 $--%>