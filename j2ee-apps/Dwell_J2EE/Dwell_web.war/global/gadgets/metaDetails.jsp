...
<dsp:page>
  ...
  <meta name="DC.identifier" scheme="DCTERMS.URI" content="<c:out value="${pageUrl}"/>" />
</dsp:page>
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/global/gadgets/metaDetails.jsp#2 $$Change: 953229 $--%>