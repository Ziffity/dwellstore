            ...
            <c:choose>
              ...
              <c:otherwise>
                <div class="atg_store_formActions"  id="atg_store_popupCloseButton">
                  ...
                  <dsp:a page="/home" iclass="atg_store_basicButton" onclick="window.close();">
                    ${closeButtonText}
                  </dsp:a>
                </div>
              </c:otherwise>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/browse/emailAFriendConfirm.jsp#1 $$Change: 946917 $--%>
