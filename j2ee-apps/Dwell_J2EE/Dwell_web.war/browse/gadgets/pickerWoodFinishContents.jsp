      ...
      <dsp:oparam name="output">
        ...
        <dsp:droplet name="WoodFinishDroplet">
          ...
          <dsp:oparam name="error">
            <p class="dijitSliderDecoration">
              <fmt:message key="global_serverError.serverErrorMsg"/>
              <fmt:message key="global_serverError.notifyAboutErrorMsg"/>
            </p>
            <p class="dijitSliderDecoration"><crs:outMessage key="company.gadget.customer_service.byEmail"/></p>
          </dsp:oparam>
        </dsp:droplet>
      </dsp:oparam>
    </dsp:droplet>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.2/Storefront/j2ee/store.war/browse/gadgets/pickerWoodFinishContents.jsp#2 $$Change: 953229 $--%>
