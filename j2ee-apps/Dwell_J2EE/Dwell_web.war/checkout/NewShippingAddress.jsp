...
<dsp:input bean="CreateHardgoodShippingGroupFormHandler.newHardgoodShippingGroup" type="submit" class="input-submit" value="Proceed to Shipping"/>
<dsp:input bean="CreateHardgoodShippingGroupFormHandler.newHardgoodShippingGroupSuccessURL" type="hidden" value="/checkout/shippingMethod.jsp"/>
<dsp:input bean="CreateHardgoodShippingGroupFormHandler.newHardgoodShippingGroupErrorURL" type="hidden" value="/checkout/shipping.jsp"/>  </td>  </tr>
</dsp:form>
</table>
